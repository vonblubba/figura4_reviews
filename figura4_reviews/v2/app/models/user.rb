class User < ActiveRecord::Base
  ...
  has_one  :external_link,    :dependent => :destroy   # homepage utente
  ...
  validates_exclusion_of :name, :in => %w{ figura4 Figura4 admin Admin administrator Administrator root Root webmaster Webmaster }
